///Метод call позволяет вызвать функцию и явно указать с каким объектом контекста её выполнить(передать в качестве первого аргумента объект, который будет доступен в функции через ключевое слово this).
