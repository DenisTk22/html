...
studentLessons.set(pavel, new Set([lessonHistory]));
// Уроки Ивана: Математика, История.
console.log(`Уроки Ивана: ${[...studentLessons.get(ivan)].join(", ")}`); // метод join разделаяет элементы массива через указанный разделитель