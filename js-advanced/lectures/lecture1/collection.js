...
console.log(uniqueBuddies); // выведет коллекцию только уникальные значения
...
// дополнение к «основному» месту хранения объекта.Если объект удаляется из
// основного хранилища и нигде не используется, кроме как в качестве ключа в
// WeakMap или в WeakSet, то он будет удалён автоматически.
