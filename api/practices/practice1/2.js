...
const removeEL = document.querySelector('#removeButton');
const cloneEl = document.querySelector('#cloneButton');
...
removeEL.addEventListener('click', () => {
  containerEl.lastElementChild?.remove(); // ? - если слева ошибка, то выполняться не будет
});
